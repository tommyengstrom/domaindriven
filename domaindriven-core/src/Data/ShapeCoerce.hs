...
gshapeCoerce :: forall a b. (Generic a, Generic b, GShapeCoercible a b (Rep a) (Rep b)) => a -> b
    ...
    ( TypeError
        ( 'Text "Cannot shapeCoerce between types:"
          ...
          ':$$: 'Text "Solution: Write instance `ShapeCoercible "
                ':<>: 'ShowType x ':<>: 'Text " " ':<>: 'ShowType y ':<>: 'Text "`"
        )
    ) =>
    GShapeCoercible x y
...
instance
    ...
    ( TypeError
        ( 'Text "Cannot shapeCoerce between types:"
          ...
          ':$$: 'Text "  To: " ':<>: 'ShowType y
          ':$$: 'Text ""
          ':$$: 'Text "Reason: Constructor " ':<>: 'ShowType name ':<>: 'Text " has different field structures"
          ':$$: 'Text ""
          ':$$: 'Text "Solution: Write instance `ShapeCoercible "
                ':<>: 'ShowType x ':<>: 'Text " " ':<>: 'ShowType y ':<>: 'Text "`"
        )
...
instance
    ...
    ( TypeError
        ( 'Text "Cannot shapeCoerce between types:"
          ...
          ':$$: 'Text "  To: " ':<>: 'ShowType y
          ':$$: 'Text ""
          ':$$: 'Text "Reason: Constructor has field " ':<>: 'ShowType name ':<>: 'Text " but none expected"
          ':$$: 'Text ""
          ':$$: 'Text "Solution: Write instance `ShapeCoercible "
                ':<>: 'ShowType x ':<>: 'Text " " ':<>: 'ShowType y ':<>: 'Text "`"
        )
